...
function Vendor() {
    ...
    useEffect(() => {
        ...
        axios({
            method: 'get',
            url:
                API_URL + 'auctions/vendor/' + vendorId,
            headers: { 'Content-Type': 'application/json' },
        })
            .then(function (response) {
            ...
            <div className="cont vendor">
                <div className="vendor_block">
                    <div className="vendor_left">
                        <img className="vendor_ava" src={IMG_URL + vendor.vendor_photo_path} alt="" />
                            ...
                            <div className="vendor_info">
                                ...
                                <div className="vendor_string">
                                    <img src={phone} alt="phone" />
                                        <Link to={`tel:${vendor.store_phone_number}`}>{vendor.store_phone_number}</Link>
                                </div>
                                <div className="vendor_string">
                                    <img src={web} alt="web" />
